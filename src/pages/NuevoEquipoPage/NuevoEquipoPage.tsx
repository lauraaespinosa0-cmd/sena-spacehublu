      ...
      <form onSubmit={handleSubmit} className="space-y-4 font-mono text-xs">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            ...
            <select value={estado} onChange={(e) => setEstado(e.target.value as typeof estado)} className="w-full bg-slate-900 border border-slate-700 rounded-xl p-2.5 text-white focus:outline-none focus:border-sena-green">
